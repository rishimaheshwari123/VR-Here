...
import { findVendor } from "../../service/operations/user";
// import DisplayTifin from "../../components/tifin/DisplayTifin";
...
const TifinForm = () => {
  ...
  const getVendor = async () => {
    if (user?._id) {
      const response = await findVendor({ id: user._id });
      setActive(response);
    } else {
      ...
      {active?.isActive ? (
              ...
              >
                <div className="flex flex-col">
                  ...
                  <input
                    type="text"
                    {...register("name", {
                      required: "Tifin Name is required",
                    })}
        ...
        <>
          ...
          >
            ...
            <p>Please contact the admin for verification.</p>
            <p className="mt-2">
              Admin Contact: <strong>9009594537</strong>
            </p>
          </div>
        </>
      )}
